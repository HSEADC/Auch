...
var token = 'patDab5w4Sw8jz0nM.f55eead8b8b719b53aedd5c9350059c4fbd31a97c2c7211c748f5f810efeb7f0';
airtable_umd_default().configure({
  endpointUrl: 'https://api.airtable.com',
  apiKey: token
});
var base = airtable_umd_default().base('app4vbHwkWBHl7Tg0');

function getPostTeasers() {
  return new Promise(function (resolve, reject) {
    var content = [];
    base('Post Teasers').select({
      maxRecords: 100
...
var M_SearchForm = /*#__PURE__*/function (_React$Component) {
  ...
  function M_SearchForm(props) {
    ...
    M_SearchForm_defineProperty(M_SearchForm_assertThisInitialized(_this), "handleSearchSubmit", function () {
...
;// CONCATENATED MODULE: ./src/components/S_SearchBar/S_SearchBar.jsx
function S_SearchBar_typeof(obj) { "@babel/helpers - typeof"; return S_SearchBar_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, S_SearchBar_typeof(obj); }

function S_SearchBar_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function S_SearchBar_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function S_SearchBar_createClass(Constructor, protoProps, staticProps) { if (protoProps) S_SearchBar_defineProperties(Constructor.prototype, protoProps); if (staticProps) S_SearchBar_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }

function S_SearchBar_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); Object.defineProperty(subClass, "prototype", { writable: false }); if (superClass) S_SearchBar_setPrototypeOf(subClass, superClass); }

function S_SearchBar_setPrototypeOf(o, p) { S_SearchBar_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return S_SearchBar_setPrototypeOf(o, p); }

function S_SearchBar_createSuper(Derived) { var hasNativeReflectConstruct = S_SearchBar_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = S_SearchBar_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = S_SearchBar_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return S_SearchBar_possibleConstructorReturn(this, result); }; }

function S_SearchBar_possibleConstructorReturn(self, call) { if (call && (S_SearchBar_typeof(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return S_SearchBar_assertThisInitialized(self); }

function S_SearchBar_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function S_SearchBar_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }

function S_SearchBar_getPrototypeOf(o) { S_SearchBar_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return S_SearchBar_getPrototypeOf(o); }

function S_SearchBar_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var S_SearchBar = /*#__PURE__*/function (_React$Component) {
  S_SearchBar_inherits(S_SearchBar, _React$Component);

  var _super = S_SearchBar_createSuper(S_SearchBar);

  function S_SearchBar(props) {
    var _this;

    S_SearchBar_classCallCheck(this, S_SearchBar);

    _this = _super.call(this, props);

    S_SearchBar_defineProperty(S_SearchBar_assertThisInitialized(_this), "handleSearchSubmit", function (value) {
  ...
  S_SearchBar_createClass(S_SearchBar, [{
    ...
    value: function render() {
      ...
      var posts = [];
      this.state.postTeasers.forEach(function (teaser) {
        posts.push( /*#__PURE__*/react.createElement("div", {
          className: "postTeaser"
        }, teaser.title));
      });
      return /*#__PURE__*/react.createElement("div", {
        className: "S_SearchBar"
...
var root = (0,client/* createRoot */.s)(document.querySelector('.S_MenuBar .W_Search'));
root.render( /*#__PURE__*/react.createElement(S_SearchBar, null));
})();
